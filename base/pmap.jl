...
function pgenerate(p::WorkerPool, f, c; distributed=true, batch_size=1, on_error=nothing,
                                        ...
                                        retry_n=0,
                                        retry_max_delay=DEFAULT_RETRY_DELAY)
...
"""
    pmap([::WorkerPool], f, c...; distributed=true, batch_size=1, on_error=nothing, retry_on=e->true, retry_n=0, retry_max_delay=0) -> collection
